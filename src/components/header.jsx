      ...
      <header className='flex justify-between items-center mb-5 pt-2 '>
        ...
        <div className='flex gap-10'>
          <ul className='flex items-center gap-[4.4rem] text-lg pr-[6.5rem]'>
                <button className='relative cursor-pointer transition-all ease-in-out before:transition-[width] before:ease-in-out before:duration-500 before:absolute before:bg-[#C1DFC4] before:origin-center before:h-[2px] before:w-0 hover:before:w-[50%] before:bottom-0 before:left-[50%] after:transition-[width] after:ease-in-out after:duration-500 after:absolute after:bg-[#C1DFC4] after:origin-center after:h-[2px] after:w-0 hover:after:w-[50%] after:bottom-0 after:right-[50%]'>Home</button>
